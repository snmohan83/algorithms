...
// fro the set of vertices not yet included in shortest path tree
...
void dijkstra(int graph[V][V], int src) {
    ...
    for (int count = 0; count < V-1; count++) {
        ...
        for (int v = 0; v < V; v++)
            ...
            // u to v, and total weight of path from src to v through is
...
int main() {
    // Creating the example graph discussed above
